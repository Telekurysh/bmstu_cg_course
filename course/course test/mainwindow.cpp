...
void MainWindow::renderFromCache() {
    LightSource lightSource = myScene.getLightSource();
    generateCloud.renderFromCache(myScene, lightSource);
    ui->draw_label->setPixmap(myScene.getPixmap());
    ui->settings_list->clear();
    ui->settings_list->append("k = " +  QString::number(myScene.k));
    ui->settings_list->append("dx = " +  QString::number(myScene.dx));
    ...
    ui->settings_list->append("Light Source Position X = " + QString::number(lightSource.getPosition().x()));
    ui->settings_list->append("Light Source Position Y = " + QString::number(lightSource.getPosition().y()));
    ui->settings_list->append("Light Source Position Z = " + QString::number(lightSource.getPosition().z()));
    ui->settings_list->append("Light Source Color = (" +
                              QString::number(lightSource.getColor().red()) + ", " +
                              QString::number(lightSource.getColor().green()) + ", " +
                              QString::number(lightSource.getColor().blue()) + ")");
}
